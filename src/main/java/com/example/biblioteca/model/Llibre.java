...
public class Llibre {
    ...
    public Integer getPagines() { return pagines; }
    public void setPagines(Integer pagines) { this.pagines = pagines; }
    ...
    public List<Lectura> getLectures() { return lectures; }
    public void setLectures(List<Lectura> lectures) { this.lectures = lectures; }

    public Set<Categoria> getCategories() { return categories; }
    public void setCategories(Set<Categoria> categories) { this.categories = categories; }
}